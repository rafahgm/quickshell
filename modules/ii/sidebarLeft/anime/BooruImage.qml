                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        MenuButton {
                            ...
                            buttonText: "Abrir link do arquivo"
                            onClicked: {
                        ...
                        MenuButton {
                            ...
                            Layout.fillWidth: true
                            buttonText: `Ir para fonte ${StringUtils.getDomain(root.imageData.source)}`
                        ...
                        MenuButton {
                            ...
                            onClicked: {
                                ...
                                Quickshell.execDetached(["bash", "-c", 
                                    `mkdir -p '${targetPath}' && curl '${root.imageData.file_url}' -o '${targetPath}/${root.fileName}' && notify-send 'Download concluído' '${root.downloadPath}/${root.fileName}' -a 'Shell'`
                                ])
                            }
                        }
                    }
