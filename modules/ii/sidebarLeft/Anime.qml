...
Item {
    ...
    property var allCommands: [
        {
            name: "mode",
            description: "Defina o provedor de API",
            execute: (args) => {
        ...
        {
            name: "clear",
            description: "Limpar a lista de imagens atuais",
            execute: () => {
        ...
        {
            name: "next",
            description: "Próxima página de resultados",
            execute: () => {
        ...
        {
            name: "safe",
            description: "Desabilitar conteúdo NSFW",
            execute: () => {
        ...
        {
            name: "lewd",
            description: "Permitir conteúdo NSFW",
            execute: () => {
    ...
    function handleInput(inputText) {
        if (inputText.startsWith(root.commandPrefix)) {
            ...
            if (commandObj) {
                ...
                Booru.addSystemMessage("Comando desconhecido: " + command);
            }
        }
        ...
        Rectangle { // Tag input area
            ...
            RowLayout { // Input field and send button
                ...
                StyledTextArea { // The actual TextArea
                    ...
                    placeholderText: `Insira tags, ou ${root.commandPrefix} para comandos`
            ...
            RowLayout { // Controls
                ...
                ApiInputBoxIndicator { // Tool indicator
                    ...
                    tooltipText: `API atual: ${Booru.providers[Booru.currentProvider].url}\nDefina com ${root.commandPrefix}mode PROVIDER`
                }
