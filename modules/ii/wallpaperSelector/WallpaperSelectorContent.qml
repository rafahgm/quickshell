            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    StyledText {
                        ...
                        text: "Selecione um papel de parede"
                    }
                    ListView {
                        // Quick dirs
                        Layout.fillHeight: true
                ...
                Item {
                    ...
                    Toolbar {
                        ...
                        IconToolbarButton {
                            ...
                            text: "open_in_new"
                            StyledTooltip {
                                text: "Use o seletor de arquivos do sistema\nclique com o botão direito para fazer desse o comportamento padrão"
                            }
                        }
                        ...
                        IconToolbarButton {
                            ...
                            text: "ifl"
                            StyledTooltip {
                                text: "Selecione um aletório dessa pasta"
                            }
                        }
                        ...
                        IconToolbarButton {
                            ...
                            StyledTooltip {
                                text: "Clique para alternar entre o modo claro/escuro\n(aplicado quando o papel de parede for escolhido)"
                            }
                        }

                        ToolbarTextField {
                            id: filterField
                            placeholderText: focus ? "Pesquisar papéis de parede": "Pressione \"/\" para pesquisar"
