...
Singleton {
	...
	function updateTrack() {
		...
		this.activeTrack = {
			...
			title: this.activePlayer?.trackTitle || "Título desconhecido",
			artist: this.activePlayer?.trackArtist || "Artista desconhecido",
			album: this.activePlayer?.trackAlbum || "Album desconhecido",
		};
